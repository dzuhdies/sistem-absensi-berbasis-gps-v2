...
<head>
    <title>Rekap Absensi Siswa Bimbingan</title>
    <meta charset="UTF-8">
...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <div class="bg-white p-5 rounded-xl shadow-md border border-gray-200 mb-6">
            ...
            <form method="GET" action="{{ route('guru.guru.rekap') }}">
                @php
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-4 gap-y-5 items-end">
                    <div>
                        ...
                        <select id="siswa_id" name="siswa_id" class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition">
                            ...
                            @endforeach
                            @if ($all_siswas->isEmpty())
                            <option value="" disabled>Belum ada siswa bimbingan</option>
                            @endif
                        </select>
                        @if ($all_siswas->isEmpty())
                        <p class="mt-1 text-xs text-red-600">Admin perlu menetapkan siswa bimbingan kepada akun guru ini.</p>
                        @endif
                    </div>
                    ...
                    <div class="flex items-center gap-2 w-full">
                        ...
                        <a href="{{ route('guru.guru.rekap') }}" class="flex items-center gap-1 justify-center p-2 bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold rounded-lg shadow-md transition-all duration-200" title="Reset Filter">
                            Reset
                        </a>
                        <a href="{{ route('guru.export.rekap', request()->query()) }}" class="w-full flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-lg shadow-md transition-all duration-200" title="Download Excel">
            ...
            <div class="overflow-x-auto">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        @empty
                        <tr>
                            <td colspan="10" class="px-6 py-10 text-center text-gray-500">Tidak ada siswa bimbingan yang terdaftar.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        @empty
                        <tr>
                            <td colspan="9" class="px-6 py-10 text-center text-gray-500">Tidak ada siswa bimbingan yang terdaftar.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
